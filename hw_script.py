...
def move_veth_to_container(c_pid, dev):
    os.system("ip link set {} netns {}".format(dev, c_pid))
...
def vxlan_tunnel(c1name, c2name):
    global SC1_id, SC1_pid
    global LC1_id, LC1_pid
    global LC2_id, LC2_pid
    global SC2_id, SC2_pid
    ...
    ns1 = "ns1-br1"
    ns2 = "ns2-br2"
    bridge_ns_name1 = 'br-ns-1'
    bridge_ns_name2 = 'br-ns-2'
...
#   assign_ip_container()
    ...
    attach_veth_to_bridge_inside_namespace(ns1, bridge1, "br_ns_lc1")
    ...
    attach_veth_to_bridge_inside_namespace(ns2, bridge2, "br_ns_lc2")
